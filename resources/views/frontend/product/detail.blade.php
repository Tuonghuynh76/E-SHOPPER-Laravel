					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{ url('/upload/product/images/'.$image[0]) }} " alt="" />
								<a href="{{ url('/upload/product/images/'.$image[0]) }}" rel="prettyPhoto"><h3>ZOOM</h3></a>
							</div>
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										...
										<div class="item {{ ($i == 1) ? '' : 'active' }}">
											...
											<a href=""><img src="{{ url('/upload/product/images/hinh85_'.$value) }}" alt="product-detail.jpg"></a>
											@endforeach
										</div>
										@endfor
									</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									@else
									<span>US ${{ $detail['price']*(100-$detail['sale'])/100 }} <p style="text-decoration: line-through; font-size: 20px"> ${{ $detail['price'] }}</p></span>
									@endif
								...
								@if($detail['sale'] != 0)
								<p><b>Condition:</b> <b style="color: red;">Sale {{ $detail['sale'] }}% </b></p>
								@else
